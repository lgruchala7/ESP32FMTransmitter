...
#define FM_SUFFIX_PAGE_ADDRESS (TX_FREQ_PAGE_ADDRESS + 1U)
#define PLAYBACK_STATE_PAGE_ADDRESS (TX_FREQ_PAGE_ADDRESS + (TX_FREQ_FONT_HEIGHT / PAGE_HEIGHT) + 1)

/* Display column addresses*/
#define TX_FREQ_COLUMN_ADDRESS COLUMN_ADDRESS_MIN
#define FM_SUFFIX_COLUMN_ADDRESS (TX_FREQ_COLUMN_ADDRESS + (6 * TX_FREQ_FONT_WIDTH))
