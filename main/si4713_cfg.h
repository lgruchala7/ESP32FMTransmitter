...
#define T_CTS_SHORT_MS                                                                             \
    1U /* CTS bit setting delay in ms (other commands) (300 us rounded up to ms) */
...
#define T_INT_MS                                                                                   \
    1U /* Interrupt duration in us after command is executed. (1 us rounded up to ms)  */
...
#define POWER_UP_DEFAULT_VAL                                                                       \
    0x1250U /* Set to FM Transmit. Enable interrupts; Set to Analog Line Input. */
#define TX_LINE_INPUT_LEVEL_DEFAULT_VAL                                                            \
    0x327CU /* Input Range = 3 (636mV_PK, 60kΩ); Max peak input level = 0x27C (636mV_PK) */
#define GPO_IEN_DEFAULT_VAL 0x00C1U /* Set STCIEN, ERRIEN, CTSIEN */
// #define REFCLK_FREQ_DEFAULT_VAL 0x8000U             /* REFCLK = 32.768 kHz */
#define REFCLK_PRESCALE_DEFAULT_VAL                                                                \
    0x0190U /* Divide by 400 (example RCLK = 13 MHz, REFCLK = 32.5 kHz) */
...
#define TX_TUNE_POWER_DEFAULT_VAL                                                                  \
...
#define TX_ACOMP_ATTACK_TIME_DEFAULT_VAL 0x0009U  /* Attack time = 9 (5 ms) */
#define TX_ACOMP_ENABLE_DEFAULT_VAL 0x0003U       /* Enable the limiter and compressor. */
#define TX_LIMITER_RELEASE_TIME_DEFAULT_VAL                                                        \
    0x000DU                                  /* Sets the limiter release time to 13 (39.38 ms). */
